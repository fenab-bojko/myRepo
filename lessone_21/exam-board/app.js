...
$header.innerHTML = `
    ...
    <div data-name='add-task' class='button button-primory'>
        <img data-name='add-task' src="images/add.svg" alt="">
        <span data-name='add-task'>Add task</span>
    </div>
`
...
$plugTask.innerHTML = `<div data-name='add-task'><img data-name='add-task' src="images/to-do-list.png" alt=""></div>`
